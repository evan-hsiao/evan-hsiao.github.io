import{_ as s,o as n,c as a,a as e}from"./app.45fb3b71.js";const l="/assets/default_homepage.222e7472.png",D=JSON.parse('{"title":"首頁 Home","description":"","frontmatter":{},"headers":[],"relativePath":"frontend_develop/vitepress/home.md","lastUpdated":1683292222000}'),p={name:"frontend_develop/vitepress/home.md"},o=e('<h1 id="首頁-home" tabindex="-1">首頁 Home <a class="header-anchor" href="#首頁-home" aria-hidden="true">#</a></h1><p>官方提供預設模板介面，然後使用<code>frontmatter</code>規則來描述設定，坦白說有點不習慣，光是空白、橫線..等，都會影響畫面呈現。</p><p>下方就是官網首頁畫面，制式化的風格。 <img src="'+l+`" alt="homepage"></p><p>預設名稱叫<code>hero</code>英雄模式，下方是官方設定的內容 :</p><div class="language-md"><button title="Copy Code" class="copy"></button><span class="lang">md</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#676E95;font-style:italic;">&lt;!-- index.md --&gt;</span></span>
