import{_ as s,c as n,o as a,d as l}from"./app.5a2dc0fe.js";const y=JSON.parse('{"title":"基本配置","description":"","frontmatter":{},"headers":[{"level":2,"title":"Import","slug":"import","link":"#import","children":[]},{"level":2,"title":"CORS","slug":"cors","link":"#cors","children":[]},{"level":2,"title":"AXIOS","slug":"axios","link":"#axios","children":[]},{"level":2,"title":".env","slug":"env","link":"#env","children":[]}],"relativePath":"frontend_develop/vite/baseset.md","lastUpdated":null}'),e={name:"frontend_develop/vite/baseset.md"},p=l(`<h1 id="基本配置" tabindex="-1">基本配置 <a class="header-anchor" href="#基本配置" aria-hidden="true">#</a></h1><p>安裝後基本資料夾架構。</p><div class="language-cmd"><button title="Copy Code" class="copy"></button><span class="lang">cmd</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">first_vite/</span></span>
...
<span class="line"><span style="color:#A6ACCD;">├── src </span><span style="color:#89DDFF;">(</span><span style="color:#A6ACCD;">所有頁面程式設定放置區</span><span style="color:#89DDFF;">)</span></span>
...
<span class="line"><span style="color:#A6ACCD;">│   │   └── xxx.css | .svg | .jpg</span></span>
...
<span class="line"><span style="color:#A6ACCD;">│   │   └── xxx.vue | .ts</span></span>
...
<span class="line"></span></code></pre></div><h2 id="import" tabindex="-1">Import <a class="header-anchor" href="#import" aria-hidden="true">#</a></h2><p>陸續補上文章...</p><h2 id="cors" tabindex="-1">CORS <a class="header-anchor" href="#cors" aria-hidden="true">#</a></h2><p>陸續補上文章...</p><h2 id="axios" tabindex="-1">AXIOS <a class="header-anchor" href="#axios" aria-hidden="true">#</a></h2><p>陸續補上文章...</p><h2 id="env" tabindex="-1">.env <a class="header-anchor" href="#env" aria-hidden="true">#</a></h2>`,10),o=[p];function t(c,r,i,A,C,D){return a(),n("div",null,o)}const h=s(e,[["render",t]]);export{y as __pageData,h as default};
